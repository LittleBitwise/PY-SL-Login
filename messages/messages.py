...
if __name__ == "__main__":
    ...
    data = zerocode.hex2byte(
        "40 00 00 00 33 00 FF FF 00 8B 12 57 75 6C 66 69 65 20 52 65 61 6E 69 6D 61 74 6F 72 00 77 9E 1D 56 55 00 4E 22 94 0A CD 7B 5A DD DB E0 77 9E 1D 56 55 00 4E 22 94 0A CD 7B 5A DD DB E0 01 01 01 2A B0 E3 42 F3 15 A6 41 FD 8B BC 41 05 00 74 65 73 74 00"
    )
